<ul class="c-sidebar-nav">
    @auth('admin')
        ...
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('admin.profil.index') }}">
                    Ubah Profil</a>
                </li>
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('admin.ganti_password') }}">
                    Ganti Password</a>
                </li>
            </ul>
        </li>
    @else
        ...
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
            <i class="cil-basketball c-sidebar-nav-icon"></i> Ekstrakurikuler</a>
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('ekstrakurikuler_mhs.index') }}">
                    Daftar Ekstrakurikuler</a>
                </li>
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('ekstrakurikuler_mhs.create') }}">
        ...
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('sertifikasi.index') }}">
                    Daftar Sertifikasi</a>
                </li>
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('sertifikasi.create') }}">
        ...
        <li class="c-sidebar-nav-dropdown"><a class="c-sidebar-nav-dropdown-toggle" href="#">
            ...
            <ul class="c-sidebar-nav-dropdown-items">
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('kegiatan.index') }}">
                    Daftar Kegiatan</a>
                </li>
                <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ route('kegiatan.create') }}">
                    Tambah Kegiatan</a>
                </li>
            </ul>
        </li>
